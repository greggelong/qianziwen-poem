class Drop {
  ...
  String [] ppoem = {"name","some","after","moon","of","and","born","east","word","big","return","see","water","hear","friend","below","few","eight","meeting","sun","woman","clock","think","good","have","sky","vegetables","year","car","capital","old","tall","work","air","child","one","again","go","who","speak","bright","clothes","garment","east","go out","rain","thank","read","language","meal","love","west","son","face","joyous","exist","heat","ability","fly","not","study","more","man","middle","machine","be","fire","rise","up","sit","time","two","book","prosper","knowledge","age","write","cup","I","labor","teacher","part", "arrive","five", "nine", "four", "alike", "star", "man","country","fruit", "answer","family","root"}; 
  float size;
  int poemIdx;
